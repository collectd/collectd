...
Network gateway provides the MBus data remotely over TCP/IP.
...
Note that some devices on the serial bus might be picky about the speed. If you cannot find
your device try setting the supported speed - e.g.

    mbus-serial-scan -d 2400 /dev/ttyS0
