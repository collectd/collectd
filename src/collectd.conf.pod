...
=head2 Plugin C<logtail>

The I<logtail> plugin works like C<tail -f> with analyze of URI, statuscode, time or size.
It can count,summarize,avg,percentile of these values. 

It's try to save memory and CPU extremly, tries to avoid heap fragemtation. 
It operates with memory pools which will be allocated per every C<Plugin> -> C<Files> -> C<Match> -> C<Report> chain.
...
Every C<Plugin> can have 1 or more C<Files> sections, each of them specifies 1 or more files or filemasks.
Every C<Files> have 1 or more C<Match> sections, Every new line of file will be parsed and URL will be matched with first C<Prefix>, C<Suffix> or C<Exact> Keyword. 
For every matched C<Match> can be 0 or more C<Report> sections.

Synopsis:

## optional parameters with default values have one comment symbol
 <Plugin "logtail">
            ## many files or glob-filemasks can be specified
...
# what to match for URI
        <Match>
          ...
          <Report>
              Type "count"
              Instance "total"  # optional. collectd-internal prefix make it "counter-total"
          </Report>
          <Report>
              Type "count_code"
              Threshold 200 300 400 404 405 500 501 505
              Instance "code-%d" # optional
          </Report>
          <Report>
              Type "count_time"
              Threshold 1000 10000 100000 1000000
              Instance "time-%d" # optional
          </Report>
          <Report>
              Type "count_size"
              Threshold 1000 10000 100000 1000000
          ...
          <Report>
              Type "sum_size"
             Instance "sum_size"  # optional
          </Report>
          <Report>
              Type "avg_size"
              Instance "avg_size"  # optional
          </Report>
          <Report>
              Type "avg_time"
              Instance "avg_time"  # optional
          </Report>
          <Report>
              Type "pct_time" # percentile
              Threshold 50 90 99
              Instance "pct_time"  # optional
          </Report>
          <Report>
              Type "pct_size"   # percentile
              Threshold 50 90 99
              Instance "pct_size"  # optional
          </Report>
        </Match>
        <Match>
