...
=item B<SeparatePluginInstance> B<false>|B<true>
...
=item B<SeparateTypeInstance> B<false>|B<true>
...
This parameter does both separations B<SeparateTypeInstance> and 
B<SeparatePluginInstance> at once.
...
=item B<AddPathSeparator> I<Char>
...
You can add additional levels by adding a special B<AddPathSeparator> character wherever 
...
By example if AddPathSeparator = @
