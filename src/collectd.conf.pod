...
Synopsis:
 ...
 <Plugin "write_http">
   <Node "example">
     ...
     User "collectd"
     Password "weCh3ik0"
     Proxy "http://proxyuser:proxypass@10.0.1.2:3128"
     Format JSON
   </Node>
 </Plugin>
...
Enable the use of a proxy server for HTTP requests. See
L<http://curl.haxx.se/libcurl/c/CURLOPT_PROXY.html> for details and syntax.
