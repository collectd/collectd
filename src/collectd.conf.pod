...
=item B<ReportCPU> B<true>|B<false>

By setting this option to B<true>, the B<irq>-plugin will collect data with
per CPU usage. Defaults to B<false>, data is all CPUs sum.
