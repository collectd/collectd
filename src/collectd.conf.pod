...
=item B<LowercaseMetricNames> B<false>|B<true>

If set the B<true>, all metrics will be lower cased before sending them off 
to carbon/graphite. If set to B<false>(the default), the metric is left
untouched.
