...
The I<Mesh plugin> collects some statistics about the Wifi Mesh performance.
The Linux kernel requires to be compile with CONFIG_MAC80211_DEBUGFS=y.
...
=item B<PhysicalDevice> I<Name>

Specifies a block containing the physical WiFi device name found under
I</sys/kernel/debug/ieee80211/>.

=item B<NetworkDevice> I<Name>

Specifies the network interface associated with the WiFi mesh, typically
found in the system's network configuration.
