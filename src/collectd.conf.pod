...
=item B<RRADef> I<timespan> I<pdp per row> I<rra types list> I<XFF>
...
Timespan : same as RRATimespan

pdp per row : defines the precision of a RRA (multiply with the interval to know it).

rra types list : same as RRA

XFF : same as XFF

Except for timespan, you can write "default" and the default value will be used.

When receiving metrics with interval=60, configuration is computed as it was :
RRADef     3600   1 MIN,MAX,AVERAGE 0.1
RRADef    86400   1 MIN,MAX,AVERAGE 0.1
RRADef   604800   8 MIN,MAX,AVERAGE 0.1
RRADef  2678400  37 MIN,MAX,AVERAGE 0.1
RRADef 31622400 439 MIN,MAX,AVERAGE 0.1
