...
Number of seconds to pass before a host is notified as missing. Defaults to B<30>.

=item B<DelayInterval> I<Seconds>

Number of seconds after startup to suppress missing notifications. Defaults to B<0>.
