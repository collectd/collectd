...
The I<intel_pmu> plugin collects performance counters data on Intel CPUs and GPU using
...
=item B<ReportGPUEvents> B<false>|B<true>

Enable or disable measuring of software events provided by i915 driver in kernel:
  - i915/bcs0-busy
  - i915/rcs0-busy
  - i915/vcs0-busy
  - i915/vcs1-busy/
  - i915/vecs0-busy
  - i915/actual-frequency
  - i915/requested-frequency
