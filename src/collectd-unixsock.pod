...
=item B<alert_name=>I<Alert-Name>

The alert name is an optional value that can be defined in the notification to
provide a meaningful name to the event being raised.
