...
=item B<evalstate> I<E<lt>identifierE<gt>>

Forces the evaluation of the state of the value identified by the specified
I<E<lt>identifierE<gt>>.

=item B<flushstate> I<E<lt>identifierE<gt>>

Flush the state of the value identified by the specified
I<E<lt>identifierE<gt>>. The state is set to UNKNOWN.
