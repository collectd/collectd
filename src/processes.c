...
static void ps_fill_details(const collectd_procstat_t *ps,
...
static collectd_procstat_t *ps_list_register(const char *name,
                                             const char *regexp) {
...
static void ps_update_delay(collectd_procstat_t *out,
                            collectd_procstat_entry_t *prev,
...
static int ps_read(void) {
  ...
  for (collectd_procstat_t *ps_ptr = list_head_g; ps_ptr != NULL;
       ps_ptr = ps_ptr->next)
